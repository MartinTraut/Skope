...
export function Footer() {
  ...
  return (
    <footer className="border-t border-white/10 bg-ink-800 pt-20 pb-10">
      <Container>
          ...
          <div className="lg:col-span-5">
            ...
            <address className="mt-8 flex flex-col gap-3 not-italic">
              <a
                ...
                className="inline-flex items-start gap-3 text-paper/80 transition-colors hover:text-flame"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-3 text-paper/80 transition-colors hover:text-flame"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-3 break-all text-paper/80 transition-colors hover:text-flame"
              >
          ...
          <div className="lg:col-span-4">
            ...
            <ul className="mt-6 grid grid-cols-2 gap-x-6 gap-y-2.5">
              {serviceArea.map((place) => (
                <li
                  key={place.name}
                  className="flex items-baseline justify-between gap-2 border-b border-white/8 pb-2 text-sm"
                >
        ...
        <div className="mt-16 border-t border-white/10 pt-8">
          <p className="max-w-3xl text-xs leading-relaxed text-paper/60">
            {priceNote}
          </p>
            ...
            <ul className="-my-2 flex flex-wrap gap-x-4">
              {legalNav.map((item) => (
                <li key={item.href}>
                  <Link
                    href={item.href}
                    className="-mx-2 inline-flex min-h-11 items-center px-2 text-xs text-paper/70 transition-colors hover:text-flame"
                  >
                    {item.label}
                  </Link>
                </li>
